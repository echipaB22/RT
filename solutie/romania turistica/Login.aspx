<%@ Page Title="" Language="C#" MasterPageFile="~/romania turistica/MasterPage.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="romania_turistica_Login" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:Login ID="Login1" runat="server" DestinationPageUrl="~/romania turistica/Contact.aspx" Height="207px" Width="446px">
        <LayoutTemplate>
